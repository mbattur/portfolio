var albumPicasso = {
 ...
 var albumMarconi = {
  ...
  var albumJaga = {
     ...
     label: 'EM',
     year: '2016',
     albumArtUrl: 'assets/images/18.png',
     songs: [
         { title: 'Keep going', duration: '1:01' },
         { title: 'New information', duration: '5:01' },
         { title: 'Educate yourslef', duration: '3:21'},
         { title: 'Why did i start this?', duration: '3:14' },
         { title: 'Wrong thinking', duration: '2:15'}
     ]
 };